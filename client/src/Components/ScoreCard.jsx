                                                ...
                                                <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                    ...
                                                    <td className="px-4 py-4">
                                                        <div className="flex items-center gap-1">
                                                            <button type="button" className="text-white bg-blue-dark hover:bg-blue-800 focus:outline-none focus:ring-blue-300 font-sm rounded-full text-sm px-3 py-2.5 text-center me-1 mb-1" onClick={() => handleScoreUpdate(player.username, -2)} disabled={!isCreator}>-2</button>
                                                            <button type="button" className="text-white bg-maroon-normal hover:bg-blue-800 focus:outline-none focus:ring-blue-300 font-sm rounded-full text-sm px-3 py-2.5 text-center me-1 mb-1" onClick={() => handleScoreUpdate(player.username, -1)} disabled={!isCreator}>-1</button>
                                                            <button type="button" className="text-white bg-blue-light hover:bg-blue-800 focus:outline-none focus:ring-blue-300 font-sm rounded-full text-sm px-3 py-2.5 text-center me-1 mb-1" onClick={() => handleScoreUpdate(player.username, 0)} disabled={!isCreator}>Par</button>
                                                            <button type="button" className="text-white bg-salmon-light hover:bg-blue-800 focus:outline-none focus:ring-blue-300 font-sm rounded-full text-sm px-3 py-2.5 text-center me-1 mb-1" onClick={() => handleScoreUpdate(player.username, 1)} disabled={!isCreator}>+1</button>
                                                            <button type="button" className="text-white bg-indigo-normal hover:bg-blue-800 focus:outline-none focus:ring-blue-300 font-sm rounded-full text-sm px-3 py-2.5 text-center me-1 mb-1" onClick={() => handleScoreUpdate(player.username, 2)} disabled={!isCreator}>+2</button>
                                                            <button type="button" className="text-white bg-red-normal hover:bg-blue-800 focus:outline-none focus:ring-blue-300 font-sm rounded-full text-sm px-3 py-2.5 text-center me-1 mb-1" onClick={() => handleScoreUpdate(player.username, 10)} disabled={!isCreator}>X</button>
                                                        </div>
                                                    </td>
                                                </tr>
                                            )
                            ...
                            return (
                                <div>
                                    <h4>{team.teamName}</h4>
                                    {
                                        team.players.map((player) => {
                                            return (
                                                <table className="" style={{ border: "solid black", margin: "20px auto", maxWidth: "800px" }} >
                                                    <thead>
                                                        <tr>
